# base-address-analyzer

Analyze a Base address safely from input.
...
```bash
git clone https://github.com/YOUR_GITHUB_USERNAME/base-address-analyzer.git
cd base-address-analyzer
python3 -m venv .venv
